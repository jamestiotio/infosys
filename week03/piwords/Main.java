...
public class Main {
        ...
        public static final String[] WORD_LIST = { "a", "able", "about", "account", "acid", "across", "act", "addition",
                        ...
                        "attack", "attempt", "attention", "attraction", "authority", "automatic", "awake", "baby",
                        "back", "bad", "bag", "balance", "ball", "band", "base", "basin", "basket", "bath", "be",
                        "beautiful", "because", "bed", "bee", "before", "behaviour", "belief", "bell", "bent", "berry",
                        "between", "bird", "birth", "bit", "bite", "bitter", "black", "blade", "blood", "blow", "blue",
                        "board", "boat", "body", "boiling", "bone", "book", "boot", "bottle", "box", "boy", "brain",
                        "brake", "branch", "brass", "bread", "breath", "brick", "bridge", "bright", "broken", "brother",
                        "brown", "brush", "bucket", "building", "bulb", "burn", "burst", "business", "but", "butter",
                        "button", "by", "cake", "camera", "canvas", "card", "care", "carriage", "cart", "cat", "cause",
                        "certain", "chain", "chalk", "chance", "change", "cheap", "cheese", "chemical", "chest",
                        "chief", "chin", "church", "circle", "clean", "clear", "clock", "cloth", "cloud", "coal",
                        "coat", "cold", "collar", "colour", "comb", "come", "comfort", "committee", "common", "company",
                        "comparison", "competition", "complete", "complex", "condition", "connection", "conscious",
                        "control", "cook", "copper", "copy", "cord", "cork", "cotton", "cough", "country", "cover",
                        "cow", "crack", "credit", "crime", "cruel", "crush", "cry", "cup", "cup", "current", "curtain",
                        ...
                        "fall", "false", "family", "far", "farm", "fat", "father", "fear", "feather", "feeble",
                        "feeling", "female", "fertile", "fiction", "field", "fight", "finger", "fire", "first", "fish",
                        "fixed", "flag", "flame", "flat", "flight", "floor", "flower", "fly", "fold", "food", "foolish",
                        "foot", "for", "force", "fork", "form", "forward", "fowl", "frame", "free", "frequent",
                        "friend", "from", "front", "fruit", "full", "future", "garden", "general", "get", "girl",
                        "give", "glass", "glove", "go", "goat", "gold", "good", "government", "grain", "grass", "great",
                        "green", "grey", "grip", "group", "growth", "guide", "gun", "hair", "hammer", "hand", "hanging",
                        "happy", "harbour", "hard", "harmony", "hat", "hate", "have", "he", "head", "healthy", "hear",
                        "hearing", "heart", "heat", "help", "high", "history", "hole", "hollow", "hook", "hope", "horn",
                        "horse", "hospital", "hour", "house", "how", "humour", "i", "ice", "idea", "if", "ill",
                        ...
                        "line", "linen", "lip", "liquid", "list", "little", "living", "lock", "long", "look", "loose",
                        "loss", "loud", "love", "low", "machine", "make", "male", "man", "manager", "map", "mark",
                        ...
                        "regular", "relation", "religion", "representative", "request", "respect", "responsible",
                        ...
                        "shirt", "shock", "shoe", "short", "shut", "side", "sign", "silk", "silver", "simple", "sister",
                        "size", "skin", "skirt", "sky", "sleep", "slip", "slope", "slow", "small", "smash", "smell",
                        ...
                        "summer", "sun", "support", "surprise", "sweet", "swim", "system", "table", "tail", "take",
                        "talk", "tall", "taste", "tax", "teaching", "tendency", "test", "than", "that", "the", "then",
                        "theory", "there", "thick", "thin", "thing", "this", "thought", "thread", "throat", "through",
                        "through", "thumb", "thunder", "ticket", "tight", "till", "time", "tin", "tired", "to", "toe",
                        "together", "tomorrow", "tongue", "tooth", "top", "touch", "town", "trade", "train",
                        "transport", "tray", "tree", "trick", "trouble", "trousers", "true", "turn", "twist",
                        "umbrella", "under", "unit", "up", "use", "value", "verse", "very", "vessel", "view", "violent",
                        "voice", "waiting", "walk", "wall", "war", "warm", "wash", "waste", "watch", "water", "wave",
                        "wax", "way", "weather", "week", "weight", "well", "west", "wet", "wheel", "when", "where",
                        "while", "whip", "whistle", "white", "who", "why", "wide", "will", "wind", "window", "wine",
                        "wing", "winter", "wire", "wise", "with", "woman", "wood", "wool", "word", "work", "worm",
        ...
        public static void main(String[] args) {
                ...
                int[] translatedPiBase26 = BaseTranslator.convertBase(piHexDigits, 16, 26, PI_PRECISION);
                ...
                String basicConversion = DigitsToStringConverter.convertDigitsToString(translatedPiBase26, 26,
                                BASIC_ALPHABET);
                ...
                System.out.println("Problem 5: Getting word matches with base-100 and" + " frequency dictionary");
                int[] translatedPiBase100 = BaseTranslator.convertBase(piHexDigits, 16, 100, PI_PRECISION);
                char[] alphabet = AlphabetGenerator.generateFrequencyAlphabet(100, WORD_LIST);

                System.out.printf("Frequency dictionary generated: %s\n",
                                MaybeTruncateString(Arrays.toString(alphabet), 50));

                String frequencyConversion = DigitsToStringConverter.convertDigitsToString(translatedPiBase100, 100,
                                alphabet);
                System.out.printf("Digits of Pi translated into a-z: %s\n",
                                MaybeTruncateString(frequencyConversion, 50));

                Map<String, Integer> frequencySubstrings = WordFinder.getSubstrings(frequencyConversion, WORD_LIST);
                for (Map.Entry<String, Integer> entry : frequencySubstrings.entrySet()) {
                        printWithContext(frequencyConversion, entry.getValue(), entry.getKey(), 3, true);
                }
        ...
        /**
         * If the input is less than or equal to len letters long, return it unchanged.
         * If the input is greater than len letters long, trim it to len letters, then
        ...
        /**
         * Pretty print a substring of a string with some context information to either
         * side.
         * 
         ...
         * @param numContext   Max amount of context characters to take from either end
         *                     of the substring.
         */
        public static void printWithContext(String haystack, int offset, String needle, int numContext,
                        boolean shouldOffset) {
                if (offset < 0 || offset + needle.length() > haystack.length() || needle.length() < 0) {
                        return;
                }

                int substringStart = Math.max(0, offset - numContext);
                int substringEnd = Math.min(haystack.length(), offset + needle.length() + numContext);

                System.out.printf("%sSubstring '%s' found at index %d: %s%s%s\n", (shouldOffset) ? "\t" : "", needle,
                                offset, (substringStart > 0) ? "..." : "",
